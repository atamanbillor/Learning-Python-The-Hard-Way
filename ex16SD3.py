# I copied and pasted the previous ex16.py here and attempted to simplify the code so that there were less repitions by using formatting and escape sequence techniques
