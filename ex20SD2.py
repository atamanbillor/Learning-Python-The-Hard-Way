...
print(f"The current line we are printing is {current_line}\n")
# now we want to print one line at time. so we are going to add 1 to the line count as it progresses
# and then we will give that rising line count to the function we just defined and it will print the respective lines
...
#continuing to add 1 to the line count with the '+=' shorthand
# the '+=' shorthand stands for currentline + 1 = currentline
